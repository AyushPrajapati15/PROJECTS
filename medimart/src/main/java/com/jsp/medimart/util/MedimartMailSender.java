...
//		String mailBody = String.format("Dear %s,%n%n" + "I hope this email finds you well.%n%n"
//				+ "Congratulations on successfully registering for the Medikart app! We are thrilled to have you onboard and are excited to be a part of your healthcare journey.%n%n"
//				+ "With Medikart, you can now enjoy a seamless and reliable platform for all your pharmaceutical needs. Whether you're ordering medicines, tracking prescriptions, or exploring health-related products, we're here to make the process as smooth as possible.%n%n"
//				+ "Your registration details are as follows:%n%n" + "ID: %s%n" + "Name: %s%n" + "Gender: %s%n"
//				+ "Date of Birth: %s%n" + "Email: %s%n" + "Mobile: %s%n" + "Address: %s%n%n"
//				+ "Please do not hesitate to reach out if you have any questions or need assistance navigating the app. Our customer support team is always ready to help.%n%n"
//				+ "We wish you a great experience with Medikart and look forward to serving you in the future!%n%n"
//				+ "Best regards,%n" + "Ayush Prajapati%n" + "Medikart Team", member.getName(), member.getId(),
//				member.getName(), member.getGender(), member.getDob(), member.getEmailid(), member.getMobile(),
//				member.getAddress());
...
//		FileSystemResource file = new FileSystemResource(new File("src/main/resources/templates/Ferrari.jpg"));
